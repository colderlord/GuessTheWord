...
using GuessWord.Dictionary.Infrastructure.Filters;
using GuessWord.Dictionary.IntegrationEvents.EventHandlers;
using GuessWord.Dictionary.Repository;
...
namespace GuessWord.API
{
    ...
    internal sealed class ServiceConfigurator
    {
        ...
        public void ConfigureServices(IServiceCollection services, ConfigurationManager configuration)
        {
            ...
            services.AddDbContext<DictionaryContext>(o => o.UseNpgsql(configuration["PGConnectionString"]));
    ...
    internal static class CustomExtensionMethods
    {
        public static IServiceCollection AddCustomHealthCheck(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            hcBuilder
                .AddPostgreSqlCheck(
                    ...
                    name: "guessworddictionary-postgresql-check",
        ...
        public static IServiceCollection AddCustomAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            }).AddJwtBearer(options =>
            {
                ...
                options.Audience = "guessworddictionary";
            });
